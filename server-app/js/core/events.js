...
export const EVENTS = {
  ...
  // El estado de conexión con el servidor backend ha cambiado.
  // payload: boolean (true = online, false = offline, funcionando con caché local)
  SERVER_CONNECTION_CHANGED: 'server:connection-changed',

  // Llegaron datos nuevos del servidor tras la comprobación de versión en
  // segundo plano (ver core/data-manager.js). payload: ninguno — quien
  // escuche debe volver a leer del data-manager y repintar.
